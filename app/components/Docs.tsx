        ...
        <div className="p-8 md:p-12">
          ...
          >
            ...
            <motion.div variants={cardVariants}>
              ...
              >
                <div className="p-8">
                  <h3 className="text-3xl font-bold mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">
                    Pertanyaan Umum
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      ...
                      <motion.div
                        ...
                        className={`p-6 rounded-xl border overflow-hidden relative group ${
                          darkMode
            ...
            >
              <motion.button
                ...
                className={`px-8 py-4 rounded-xl font-bold flex items-center space-x-3 shadow-lg transition-all duration-300 ${
                  darkMode
